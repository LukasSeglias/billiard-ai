...
\begin{algorithm}[H]
    ...
    \Fn{\combos{reflections: int, rails: Rail[]} $\longrightarrow$ Rail[][]}{
        ...
        \For{rail in rails}{
            combinations $\longleftarrow$ append(([rail] $(0, 0)$, true), combinations)
        }
        \For{index = 0 < reflections}{
            \For{railIndex $\longleftarrow$ 0 < length(rails)}{
                ...
                \If{combinations[railIndex].third and canReflect(combinations[railIndex].second, rail)}{
                    ...
                    combinations[railIndex].second $\longleftarrow$ reflect(combinations[railIndex].second, [rail])[0]
                }
                \Else{
        ...
        \For{railIndex $\longleftarrow$ 0 < length(rails)}{
            \If{combinations[railIndex].third}{
                results $\longleftarrow$ append(combinations[railIndex].first, results)
            }
        }
