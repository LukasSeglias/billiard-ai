...
\textbf{Löcher und Banden} \ref{fig:display_table_rail_targets}: Die Löcher und Banden können über die Taste \textbf{T} angezeigt oder versteckt werden.
\begin{figure}[h!]
    \begin{center}
...
und das Resultat angezeigt. Dieser Modus hat die Intention zu lernen, wie man eine Kugel anspielen muss und hat auch
...
\textbf{Animationsfunktionalitäten} \ref{fig:unity_animation}: Die Animation eines Stosses wird automatisch nach der Suche
ausgelöst. Mittels der Tasten \textbf{Pfeil links} und \textbf{Pfeil rechts} kann innerhalb des Stosses nach vorne oder zurück
