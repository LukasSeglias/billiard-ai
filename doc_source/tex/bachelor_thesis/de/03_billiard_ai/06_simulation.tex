...
Dieser Einfluss scheint konstant, also nicht abhängig von der eingehenden Geschwindigkeit zu sein und fällt demnach
vorallem bei kleinen Geschwindigkeiten ins Gewicht. In Abbildung \ref{fig:einfluss_topspin} wird der Einfluss des
Topspins bei grossen wie auch kleinen Geschwindigkeiten erläutert. Der Einfluss des Topspins wird berücksichtigt,
...
Dieser Vektor $\vec{v_{k,t,n}}$ wird nun anstelle von $\vec{v_{k,t}}$ verwendet, wobei die maximal Energie des Vektors
