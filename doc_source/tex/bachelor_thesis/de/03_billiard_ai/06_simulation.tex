...
Konstante $E_v$, welche in Prozent angegeben wird, reduziert. Da sich der Prozentsatz auf den minimalen Energiewert aus
Kapitel \ref{EnergieuebergabeBeiKollision} bezieht, geschieht eine Umwandlung zu diesem Wert durch Division.
\begin{align}
    \vec{v_1} = \vec{v^i_1} \cdot \frac{1}{1 + E_v}\\
    \vec{v_2} = \vec{v^i_2} \cdot \frac{1}{1 + E_v}\\
\end{align}
