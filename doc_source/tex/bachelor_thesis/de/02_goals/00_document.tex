...
\begin{table}[ht]
    ...
    \begin{tabular}{llll}
        ...
        O-6 & Spielerabhängige Bewertungsfunktion & M-2 & \\\bfhmidline
...
\begin{description}
    ...
    \item[Spielerabhängige Bewertungsfunktion - O-6]\hfill \\
    Je nach Spieler kann eine andere Funktion zur Bewertung der Stösse eingestellt werden. Durch die Unterscheidung
