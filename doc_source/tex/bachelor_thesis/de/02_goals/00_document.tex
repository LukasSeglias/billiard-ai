...
Es werden zwei verschiedene Spielmodi angestrebt.
Beim ersten Modus kann der Spieler eine Kugel oder einen Kugeltypen (Farbe) wählen, nach dem gesucht wird.
...
Der zweite Modus ist der sogenannte \glqq Infinity-Mode\grqq.
...
\begin{description}
    ...
    % TODO: Spellchecker sagt "gehört" statt "gehören", was soll dieser Satz aussagen?
