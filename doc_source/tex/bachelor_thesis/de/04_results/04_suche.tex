...
Startgeschwindigkeiten und die Suche über mehrere Stösse.
...
Der Stoss 5 wird nach Tabelle \ref{tab:kosten_fuenfter_vorschlag_ohne_bande_ohne_geschwindigkeit} als schwieriger bewertet,
weil der Winkel, in dem der Spielball die Kugel 3 treffen muss, ca. 45$^{\circ}$ ist.
...
möglich erscheinen.
Zudem berücksichtigt die Bewertung der Schwierigkeit eines Stosses die gesamte Distanz, die Winkel, die Nähe
