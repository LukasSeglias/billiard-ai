...
% Titlepicture
\titlepicture{../common/resources/title_image_cropped.png}
%%

% Topic of Study
\degreeprogramme{Informatik - Computer Perception and Virtual Reality}
% Supervisor
\thesisadvisor{Marcus Hudritsch}
% Client
\projectpartner{}
% Expert
...
%    \printunsrtglossary[style={index}]
    ...
    \includepdf[pages=-]{../common/resources/erklaerung_ritz.pdf}
    \includepdf[pages=-]{../common/resources/erklaerung_seglias.pdf}
    \includepdf[pages=-]{../common/resources/aufgabenstellung.pdf}
